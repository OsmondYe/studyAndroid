...
final public class ErrorMessages {
    ...
    public static final String NON_INSTANTIABLE_CLASS =
    ...
    public static final String SIGNIN_CANCEL =
            "The user cancelled the login operation.";
